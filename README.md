...
1. Replace the `white-space: nowrap` with `white-space: normal` in the Uploaded Files tables Notes column.(/marketplace/manage_files) because when writing a longer comment the page gets horizontally out of the screen view.
